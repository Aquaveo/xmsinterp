...
/// \param tvalues: tvalues.
//------------------------------------------------------------------------------
void GmMultiPolyIntersectionSorterTerse::FixArrays(VecInt& polyids, VecDbl& tvalues) const
{
...
/// \param inNeither = indices into m_ix of intersections in this group that don't
